    <nav class="navbar navbar-inverse"style="margin-bottom: 0">   
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">TravleAce</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a class="nav-a" href="<?=$SITE_URL?>/index.php">Trang chủ</a></li>
            <li><a class="nav-a" href="#">Giới thiệu</a></li>
            <li><a class="nav-a" href="#">Đặt tour</a></li>
            <li><a class="nav-a" href="#">Dịch vụ</a></li>
             <li><a class="nav-a" href="#">Liên hệ</a></li>
          </ul>
        <div class="log">
          <?php if (isset($_SESSION['user'])) :?>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <li><a class="dropdown-item" href="index.php?dsyt">Toour yêu thích</a></li>
                <li><a class="dropdown-item" href="#">Lịch xử đặt vé</a></li>
                 <li><a class="dropdown-item" href="index.php?capnhat">Cập nhập TK</a></li>
                <li><a class="dropdown-item" href="index.php?doimk">Đổi mật khẩu</a></li>
                <li><a class="dropdown-item" href="index.php?dangxuat">Đăng xuất</a></li>
                <?php if ($_SESSION['vaitro']==1):?>
                <li><a class="dropdown-item" href="index.php?quanli">Quản lí Website</a></li>
              <?php endif;?>
            </div>
          </div> 
          <?php else :?>
          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">Đăng nhập</button>
          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal2">Đăng kí</button>
          <!-- Modal -->
        <?php endif; ?>
        </div>
        </div><!--/.nav-collapse -->
